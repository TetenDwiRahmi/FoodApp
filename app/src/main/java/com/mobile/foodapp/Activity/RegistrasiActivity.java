...
import com.mobile.foodapp.databinding.ActivityRegistrasiBinding;
...
public class RegistrasiActivity extends AppCompatActivity {
    ...
    private void registrasi_tanpafoto() {
        AndroidNetworking.post(Server.site + "register_customer.php")
                        ...
                        try {
                            if (binding.editPassword.getText().toString().equals(binding.editKonfPassword.getText().toString())) {
                                if (response.getString("status").equalsIgnoreCase("2")) {
                                    ...
                                    Toast.makeText(RegistrasiActivity.this, "Foto Harus Diisi", Toast.LENGTH_SHORT).show();
                                }
